...
class ChatConfigCog(commands.Cog):
    ...
    @commands.hybrid_command(name="xyz234321", description=current_language["toggleactive"])
    ...
    @commands.is_owner()
    async def xyz234321(self, ctx, persona: discord.app_commands.Choice[str] = instructions[instruc_config]):
